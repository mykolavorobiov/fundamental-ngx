...
export class ObjectAttributeComponent implements OnInit {
    ...
    @Output()
    objectAttributeclick: EventEmitter<MouseEvent | KeyboardEvent | TouchEvent> = new EventEmitter();
     ...
     *  Handles link click
     */
    public onObjectAttributeClick($event: MouseEvent | KeyboardEvent | TouchEvent): void {
        if (this.islink) {
